...
# Note: usability analysis just operates on fields
...
# Propagate usability information once at every node in the flow graph
...
# Compute the field usability in/out fields at every node in control flow graph
